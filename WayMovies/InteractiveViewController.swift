...
//  Interactive
//
//  Created by Shoaib Sarwar Cheema on 14/11/2016. Modified by Aaron Lichtman on Jun. 8, 2018.
...
class InteractiveViewController: UIViewController {
    ...
    var maskType: InteractiveMaskType = .darkBlur
    ...
    func showInteractive() {
        ...
        UIView.animate(withDuration: 0.5, animations: {
            if self.maskType == .black {
                ...
                window.backgroundColor = UIColor(white: 0x000000, alpha: 0.65)
            }
            self.window?.layoutIfNeeded()
        })
    }
